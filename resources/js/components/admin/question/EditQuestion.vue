    ...
    <div class="page-title-box">
		...
		<div class="row edit">
			<div class="col-12">
				<div class="card">
					<div class="card-body">
            <form class="edit-question" @submit.prevent="editQuestion">
...
export default {
  ...
  methods: {
    ...
    editQuestion() {
      ...
      axios.post(process.env.MIX_APP_URL+'/api/questions/'+self.$route.params.id, formData, {
        headers: {
  ...
  mounted: function(){
    ...
    axios.get(process.env.MIX_APP_URL+'/api/questions/' + self.$route.params.id, {
      headers: {
        'Authorization': 'Bearer '+localStorage.getItem("api_token") 
      }
    })
    .then(function (response) {
      ...
      self.loadSubCategories(response.data.question.category_id);
    }).catch(function (error) {
